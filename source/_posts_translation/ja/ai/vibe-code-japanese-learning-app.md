...
私自身の例で言うと、日本語単語を覚えるために、これまでいろいろな単語カード（フラッシュカード）アプリを使ってきました。一般的な流れは、問題を入力して、裏返すと答えが表示されるというものです。ですが日本語を覚えるときは、漢字、ひらがな、そして対応する中国語の意味の 3 つを同時に覚えたいことが多いです。本来なら 1 枚のカードにこの 3 つの欄が一緒に載っていてほしい。しかし普通の単語カードアプリだと、2 枚に分けないといけないことが多く、かえって面倒です。
